...
Para realizar el análisis de pronósticos de ventas (en un rango) de la plataforma e-commerce de Elektra Gt, a total plataforma, de manera diaria, se han identificado múltiples fuentes de información que reportan la actividad diaria de marketing a través de las redes sociales, así como el reporte de ventas diario. Las siguientes son fuentes usadas en esta primera fase del proyecto:

* **Google Analytics:** Servicio de seguimiento de actividad comercial para la página de Elektra Gt, la cual cuenta con información de las ventas diarias y resultados de las campañas implementadas cada día.
...
Dos archivos han sido entregados por parte de *DDI* para llevar a cabo el desarrollo del DEMO de pronósticos. Los archivos se encuentran en formato *.csv* y se encuentran alojados en [Google Drive](https://drive.google.com/drive/folders/1b4nUMvnV42VOHQ9hSyWrJHbs6N1Coh6R?usp=sharing)
...
tibble(
  Variable = c("Nombre", "Número de renglones", "Número de columnas", 
               ...
               "_________________________",
          "Variable de grupo"),
  Value = c("Facebook Ads", "24,774", "11", "", "", "3", "3", "5", "", "Ninguna")
) %>% 
  kable("html") %>% 
  kable_styling("striped")
```
