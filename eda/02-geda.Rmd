...
A través de los histrogramas se observa que existe una cola pesada del lado derecho, el cual corresponde al alto número de transacciones. Una transformación matemática que ayuda a comprimir los valores altos es la logarítmica, la cual tiene propiedades que auxilian a modelar y analizar estadísticamente la distribución de datos bajo estudio. El segundo gráfico muestra una distribución similar a la normal, sin embargo, sigue existiendo una cola larga del lado derecho que sesga ligeramente la media respecto a la mediana.
...
El gráfico anterior permite conocer la distribución de densidad completa y muestra los percentiles clave mencionados anteriormente. El punto rojo corresponde a la media, mientras que los negros son considerados valores atípicos debido a que se encuentran a más de 1.5 veces en rango intercuartil a partir del perceltil 75. Estos puntos corresponden a las fechas coincidentes con el *buen fin* y el *black friday*. Por último, el inicio y fin de la línea roja representan los percentiles 10 y 90.
